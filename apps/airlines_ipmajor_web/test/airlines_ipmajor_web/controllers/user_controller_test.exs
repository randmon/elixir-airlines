defmodule AirlinesIpmajorWeb.UserControllerTest do
  use AirlinesIpmajorWeb.ConnCase

  import AirlinesIpmajor.UserContextFixtures

  @create_attrs %{birthdate: ~D[2022-05-08], first_name: "some first_name", hashed_password: "some hashed_password", last_name: "some last_name", username: "some username"}
